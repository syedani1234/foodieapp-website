...
const fetchCuisineData = async (cuisineSlug) => {
  ...
  const response = await fetch(
    `${import.meta.env.VITE_API_URL || "http://localhost:4000"}/cuisines/${cuisineSlug}`,
  );
...
export default function CuisineFilterPage() {
  ...
  const cuisineName =
    cuisine?.name || (cuisineSlug ? cuisineSlug.replace(/-/g, " ") : "Cuisine");
  ...
  if (isError) {
    return (
      <Container maxWidth="lg" sx={{ py: 8 }}>
        ...
        >
          <Typography fontWeight="bold">Oops! Something went wrong</Typography>
        ...
        <Box sx={{ textAlign: "center", mt: 4 }}>
          ...
          >
            ...
            <Button
              ...
              onClick={() =>
                window.open(
                  `${import.meta.env.VITE_API_URL || "http://localhost:4000"}/api/cuisines`,
                  "_blank",
                )
              }
            >
  ...
  if (!cuisine) {
    return (
      <Container maxWidth="lg" sx={{ py: 8, textAlign: "center" }}>
        ...
        >
          We couldn't find "{cuisineName}" in our database. It might have been
    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        <Grid container spacing={4} alignItems="center">
          ...
          <Grid item xs={12} md={5}>
            <CardMedia
              ...
              image={
                cuisine.image ||
                `https://source.unsplash.com/random/600x400/?${cuisine.name},food`
              }
              alt={cuisine.name}
              sx={{
                width: "100%",
      ...
      <Box sx={{ mb: 8 }}>
        ...
        >
          <Box>
            ...
            <Typography variant="body1" color="text.secondary">
              Discover the best {cuisine.name.toLowerCase()} restaurants near
              you
            </Typography>
          </Box>
        ...
        {restaurants.length > 0 ? (
          ...
          >
            ...
            >
              There are currently no restaurants serving {cuisine.name} cuisine.
              Check back soon or explore other cuisines.
            </Typography>
            <Button
              variant="contained"
              onClick={handleGoToCuisines}
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body2" color="text.secondary">
                {cuisine.description ||
                  `Experience authentic ${cuisine.name} cuisine with our carefully selected restaurants. Each restaurant has been verified for quality, authenticity, and customer satisfaction.`}
              </Typography>
              <Button
                variant="text"
                onClick={() =>
                  window.open(
                    `https://en.wikipedia.org/wiki/${cuisine.name}_cuisine`,
                    "_blank",
                  )
                }
      ...
      <Box sx={{ mt: 6, textAlign: "center" }}>
        <Typography variant="caption" color="text.secondary">
          ...
          {cuisine.restaurant_count || restaurants.length} {cuisine.name}{" "}
          restaurants
        </Typography>
      </Box>
    </Container>
