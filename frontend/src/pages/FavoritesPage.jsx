...
export const FavoritesPage = () => {
  ...
  if (favorites.length === 0) {
    return (
      <div className="p-6 max-w-6xl mx-auto">
        <h2 className="text-2xl font-bold mb-4 text-pink-600">â­ Your Favorites</h2>
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <h2 className="text-2xl font-bold mb-6 text-pink-600">â­ Your Favorites</h2>
          ...
          >
            ...
            <div className="p-4 flex-1 flex flex-col justify-between">
              <div>
                ...
                {fav.restaurant && <p className="text-gray-500 text-sm mt-1">ðŸ“ {fav.restaurant}</p>}
              </div>
